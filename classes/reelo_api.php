...
/**
 * Firmas de CloudFront y analítica, pedidas a Reelo con el apikey del tenant.
 */
class reelo_api {
     ...
     */
    const URL = 'https://reelo.danimarqz.dev/api';

    /**
     * Identificador seudónimo y estable del alumno.
     *
     * Reelo recibe esto en vez del id, el nombre o el DNI de Moodle: basta para
    ...
    /**
     * Pide al backend de Reelo una firma de CloudFront para el prefijo de una
     * clase.
     *
     ...
     * subtítulos de esa clase, porque Reelo firma una policy cuyo recurso acaba
     ...
     *
     * Se dispara y se olvida, con un curl desacoplado: un backend de Reelo lento
